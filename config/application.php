...
/**
 * Base (production-minded) configuration.
 *
 ...
 *
 * NOTE: On Kubernetes, prefer setting env vars directly via Secret/ConfigMap
 * and do not mount a .env file.
 */
...
/**
 * Cloud-native / optional integrations
 */

// Object cache (Redis) - plugin required (e.g. redis-cache).
Config::define('WP_CACHE', env('WP_CACHE') ?? false);
Config::define('WP_REDIS_HOST', env('WP_REDIS_HOST') ?: null);
...
// Default theme shipped in this repository (can be overridden by env var).
Config::define('WP_DEFAULT_THEME', env('WP_DEFAULT_THEME') ?: 'starter-theme');

// Disable the plugin and theme file editor in the admin.
Config::define('DISALLOW_FILE_EDIT', true);

// Disable plugin and theme updates and installation from the admin by default.
...
/**
 * Debugging defaults (production-minded).
 */
...
/**
 * Allow WordPress to detect HTTPS when used behind a reverse proxy/load balancer.
